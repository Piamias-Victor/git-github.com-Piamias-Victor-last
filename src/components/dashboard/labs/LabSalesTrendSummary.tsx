// src/components/dashboard/labs/LabSalesTrendSummary.tsx
...
interface LabSalesTrendSummaryProps {
  laboratories: Laboratory[];
  allProducts: Product[];
}

export function LabSalesTrendSummary({ 
  laboratories, 
  allProducts 
}: LabSalesTrendSummaryProps) {
  ...
  const trends = useMemo(() => {
    ...
    return labProducts.reduce((acc, product) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
      <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">
        Évolution des ventes des laboratoires sélectionnés
      </h4>
