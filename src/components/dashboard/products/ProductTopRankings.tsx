...
interface ProductTopRankingsProps {
  products: Product[];
}

type RankingType = 'sales' | 'margin' | 'rotation';

export function ProductTopRankings({ products }: ProductTopRankingsProps) {
  ...
  const getRankingTitle = () => {
    switch (rankingType) {
      case 'sales': return 'Top 5 - Ventes';
      case 'margin': return 'Top 5 - Marge';
      case 'rotation': return 'Top 5 - Rotation';
    }
  };
